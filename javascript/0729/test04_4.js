...
let arr1 = [
  "문자자료", 5, [2,4,6,8], {tel: '010-1234-5678'}, function(){ console.log("안녕하세요");}
];

console.log("arr1 : ", arr1);
console.log("arr2[2] : ", arr1[2]);
console.log("arr2[2] : ", arr1[4]);
...
let res3 = arr3.sort(); // 문자형식에 따른 정렬. [10,11,15,17,20,8]
console.log("res3 : ", res3);

res3 = arr3.sort((a,b)=> a-b);  // 오름차순 정렬
console.log(res3);
console.log("");
res3 = arr3.sort((a,b)=> b-a);  // 내림차순 정렬
console.log(res3);
console.log("");
